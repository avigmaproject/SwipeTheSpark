    ...
    public class User_Notification_Data : IUser_Notification_Data
    {
        ...
        private List<dynamic> CreateUpdate_User_Notification(User_Notification_DTO model)
        {
            ...
            using (IDbConnection con = Connection)
            {
                ...
                try
                {
                    ...
                    cmd.Parameters.AddWithValue("@NT_UP_PKeyID", model.NT_UP_PKeyID);
                    cmd.Parameters.AddWithValue("@NT_US_PKeyID", model.NT_US_PKeyID);
                    cmd.Parameters.AddWithValue("@NT_UPC_PkeyID", model.NT_UPC_PkeyID);
                    cmd.Parameters.AddWithValue("@NT_UL_PKeyID", model.NT_UL_PKeyID);
                    cmd.Parameters.AddWithValue("@NT_C_L", model.NT_C_L);
                    cmd.Parameters.AddWithValue("@NT_SP_PKeyID", model.NT_SP_PKeyID);
                    cmd.Parameters.AddWithValue("@NT_FLL_PKeyID", model.NT_FLL_PKeyID);
                    cmd.Parameters.AddWithValue("@NT_Creator_PKeyID", model.NT_Creator_PKeyID);
                    cmd.Parameters.AddWithValue("@NT_Creator_Group_PKeyID", model.NT_Creator_Group_PKeyID);
                    cmd.Parameters.AddWithValue("@NT_User_Subs_PkeyID", model.NT_User_Subs_PkeyID);
                    cmd.Parameters.AddWithValue("@NT_UPG_PkeyID", model.NT_UPG_PkeyID);
                    cmd.Parameters.AddWithValue("@NT_ChannelName", model.NT_ChannelName);
                    cmd.Parameters.AddWithValue("@NT_ChannelToken", model.NT_ChannelToken);
                    cmd.Parameters.AddWithValue("@NT_TP_PKeyID", model.NT_TP_PKeyID);
                    cmd.Parameters.AddWithValue("@NT_UCD_User_PkeyID", model.NT_UCD_User_PkeyID);
        ...
        public int SendFireBaseNotification(User_Notification_DTO model)
        {
            ...
            try
            {
                ...
                DataSet ds = notification_Data.Get_UserDetailsByPost_Story(user_Post_DTO);

...
namespace SwipeTheSpark.Repository.Avigma
{
    public class GetSetUser
    {
        ...
        //public List<dynamic> GetVerificationLinkOTP(EmailDTO emailDTO, int OTP)
        //{
        //    List<dynamic> objDynamic = new List<dynamic>();
        //    try
        //    {
        ...
        //        //List<dynamic> userMaster_DTOs = new List<dynamic>();
                ...
                if (ds.Tables.Count > 0)
                {
                    ...
                    List<ViewLogin> ViewLogin =
                       (from item in myEnumerableFeaprd
                        ...
                        {
                            intUSerId = item.Field<long?>("User_PkeyID"),
                            IsVerified = item.Field<bool?>("User_IsVerified"),
                        }).ToList();
